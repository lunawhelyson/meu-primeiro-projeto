...
public class ModelTelefone implements Serializable {
	...
	private ModelLogin usuario_pai_id; // RELACIONAMENTO DE OBJETOS
	private ModelLogin usuario_cad_id; // RELACIONAMENTO DE OBJETOS
	...
	// PARA NÃO GERAR PROBLEMA DE CONPILAÇÃO
	@Override
	public int hashCode() {
