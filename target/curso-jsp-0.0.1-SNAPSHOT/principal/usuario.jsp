...
<span id="totalResultados"></span>
 ...
 // JQUERY	FAZ QUE O CAMPO DA TELA ACEITE SÓ NÚMERO
 ...
 function buscaUserPagAjax(url) {
   ...
   var json = JSON.parse(response);
		...
		$('#tabelaresultados > tbody > tr').remove(); <!-- Função jquery-->
...
function buscarUsuario() {
	 ...
	 var urlAction = document.getElementById('formUser').action; <!-- Endereço da Servelt -->
	 ...
	 if (confirm("deseja realmente excluir os dados?")){
		 ...
		 $.ajax({
			 ...
			 success: function(response) {
				 ...
				 limparForm(); <!-- Limpa o formulário e redireciona para o inicio da página de cadastro-->
				document.getElementById('msg').textContent = response;
			}
			 
		  }).fail(function(xhr, status, errorThrown){
			alert('Erro ao deletear usuário por id: ' + xhr.responseText);
		});
