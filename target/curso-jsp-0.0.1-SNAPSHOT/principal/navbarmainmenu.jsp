                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li class="pcoded-hasmenu">
                                  ...
                                  <c:if test="${perfil == 'ADMIN'}"> 
                                      ...
                                      <li class=" ">
                                          <a href="<%=request.getContextPath()%>/ServletUsuarioController?acao=listarUser" class="waves-effect waves-dark"> <!-- Idependente onde esteja ele vai voltar a pagina principal -->
